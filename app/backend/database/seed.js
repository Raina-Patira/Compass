...
const seedDatabase = async () => {
  try {
    ...
    const expertiseTags = [
      ...
      {
        name: "Data Science",
        description: "Data analysis and science",
        category: "Data Science",
      },
      {
        name: "DevOps",
    ...
    const createdTags = await ExpertiseTag.bulkCreate(expertiseTags, {
    ...
    const userExpertiseData = [
      ...
      {
        email: "jane.smith@company.com",
        expertise: ["Python", "Machine Learning", "SQL", "Data Science"],
      },
      {
        email: "mike.johnson@company.com",
        expertise: ["Docker", "Kubernetes", "AWS", "DevOps"],
      },
      {
        email: "sarah.williams@company.com",
      ...
      {
        email: "alex.brown@company.com",
        expertise: ["JavaScript", "React", "UI/UX Design"],
      },
      {
        email: "emily.davis@company.com",
        expertise: ["Product Management", "UI/UX Design"],
      },
      {
        email: "david.wilson@company.com",
        expertise: ["Security", "AWS", "DevOps"],
      },
    ];
